...
library LiquidityLib {
        ...
        returns (uint256 price)
    {
        ...
        uint256 sharesOutScaled = scaleTokenBefore(args.share, sharesOut, args.shareDecimals);
        ...
        returns (uint256 assetsIn)
    {
        ...
        assetsIn = scaleTokenAfter(args.asset, assetsIn, args.assetDecimals);
    }
        ...
        returns (uint256 sharesOut)
    {
        ...
        (uint256 assetReserveScaled, uint256 shareReserveScaled) =
            scaledReserves(args, assetReserve, shareReserve);
        uint256 assetsInScaled = scaleTokenBefore(args.asset, assetsIn, args.assetDecimals);
        ...
        sharesOut = scaleTokenAfter(args.share, sharesOut, args.shareDecimals);
    }
        ...
        returns (uint256 sharesIn)
    {
        ...
        (uint256 assetReserveScaled, uint256 shareReserveScaled) =
            scaledReserves(args, assetReserve, shareReserve);
        uint256 assetsOutScaled = scaleTokenBefore(args.asset, assetsOut, args.assetDecimals);
        ...
        sharesIn = scaleTokenAfter(args.share, sharesIn, args.shareDecimals);
    }
        ...
        returns (uint256 assetsOut)
    {
        ...
        (uint256 assetReserveScaled, uint256 shareReserveScaled) =
            scaledReserves(args, assetReserve, shareReserve);
        uint256 sharesInScaled = scaleTokenBefore(args.share, sharesIn, args.shareDecimals);
        ...
        assetsOut = scaleTokenAfter(args.asset, assetsOut, args.assetDecimals);
    }
    ...
    {
        return
            (scaleTokenBefore(args.asset, assetReserve, args.assetDecimals), scaleTokenBefore(args.share, shareReserve, args.shareDecimals));
    }
